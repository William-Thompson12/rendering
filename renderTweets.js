function renderTweets(tweets) {
        ...
        var tweetCard = tweets.map(function(tweet){
            var profilePic = tweets[i++].user.profilePic;
            var username = tweets[j++].user.username;
            var handle = tweets[k++].user.handle;
            var isVerified = tweets[l++].user.isVerified
            return`
        <div class="tweetCard">
        <div class="media">
            <div class="pics">
            <img src="${profilePic}" class="mr-3 offset-10" alt="profile-picture">
            </div>
             <div class="media-body">
                    <h5 class="offset-1">${username}${isVerified  ? `<svg id="verifySymbol" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-patch-check-fll" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zm.287 5.984a.5.5 0 0 0-.708-.708L7 8.793 5.854 7.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3z"/>
                       ...
                       <h4 class="handle offset-1"><a href"#handle">${handle}</a></h4>
